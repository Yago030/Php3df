...
-- Tiempo de generación: 07-11-2023 a las 20:55:31
...
INSERT INTO `categorias` (`id_categoria`, `categoria`, `url`) VALUES
(1, 'Aire Acondicionado Frio Calor', 'aire-acondicionado-frio-calor'),
(2, 'Calefactores', NULL),
(3, 'Heladeras', NULL),
(4, 'Cocinas', ''),
(5, 'Termotanques', ''),
(6, 'Lavarropas', 'lavarropas'),
(7, 'Microndas', 'microndas');
