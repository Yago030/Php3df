...
function docReady(){
	...
	$('ul.gallery li').hover(function(){
		...
		$(this).append('<div class="well gallery-controls">'+
							'<p><a href="#" class="gallery-delete btn"><i class="icon-trash icon-color"></i></a></p>'+
						'</div>');
	...
	$('.thumbnails').on('click','.gallery-delete',function(e){
		...
		var conBox=confirm("Borrar Imagen: "+$(this).parents('.thumbnail').attr('id'));
		if(conBox){ 
		location.href="propiedades-eliminar-foto.php?id="+ id;
